...
def evaluate(real: Union[str, Database],
             ...
             constructor_args: Dict[str, Any], eval_args: Dict[str, Any], save_tables_to: str = 'eval_tables',
             save_eval_res_to: str = 'evaluation', save_complete_result_to: Optional[str] = None,
             save_visualization_to: str = 'visualization') -> Dict[str, pd.DataFrame]:
    """
    Evaluate a pair of real and fake databases.
    ...
    **Args**:
    ...
    - `eval_args` (`Dict[str, Any]`): Arguments to
      ...
      Only `mean` and `smooth` can be provided here.
    ...
    **Return**: A dictionary of evaluation results where keys are description of synthetic databases and values
    ...
    evaluator = SyntheticDatabaseEvaluator(
        real=real,
        save_eval_res_to=save_eval_res_to,
        save_vis_to=save_visualization_to,
        save_tables_to=save_tables_to,
        **constructor_args
    )
    results = {
